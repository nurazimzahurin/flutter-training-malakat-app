                ...
                child: SizedBox(
                  ...
                  child: FlatButton(
                      ...
                      if(_email.text == '' || _pass.text == ''){
                        showDialog(
                            ...
                            builder: (BuildContext context) {
                              return AlertDialog(
                                title: Text('Oops'),
                                content: Text('All fields are required', style: TextStyle(color: Colors.red, fontSize: 18),),
                              );
                            });
                        return;
                      }
                      ...
                      if (result == false) {
                        showDialog(
                            ...
                            builder: (BuildContext context) {
                              return AlertDialog(
                                title: Text('Oops'),
                                content: Text('Invalid credentials', style: TextStyle(color: Colors.red, fontSize: 18)),
                              );
                            });
                        return;
                      } else if (result == true) {
                    ...
                    shape: RoundedRectangleBorder(
                      ...
                      side: BorderSide(color: Color.fromRGBO(219, 69, 69, 1)),
                    ),
              ...
              Row(
                ...
                children: <Widget>[
                  Text('Forgot password? ',
                      style: TextStyle(color: Color.fromRGBO(84, 94, 218, 1))),
                  Text('or'),
                  InkWell(
                    onTap: () {
                      Navigator.push(
                    ...
                    child: Text(' Register',
                        style:
                            TextStyle(color: Color.fromRGBO(84, 94, 218, 1))),
                  ),
                ],
              )
            ],
